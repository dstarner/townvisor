      ...
      <React.Fragment>
        ...
        <Container>
          <Grid container spacing={3}>
            <Grid item xs={12}>
                <Content title={postDetails.title} author={postDetails.author.username} markdown={postDetails.mdContent} statistics={['Less than 100 views', '5 Reactions ❤️']} headerCaption={postDetails.headerCaption} headerSrc={postDetails.header}/>
                <Typography className={classes.commentsHeading} variant='h3'>Comments</Typography>
                {
